...
<head>
    ...
    <style type="text/css">
        .login-register {
            background: url('<?=base_url()?>/assets/plugins/images/login-register.jpeg') center center/cover no-repeat !important;
        }
    </style>
        ...
        <div class="login-box">
            <div class="white-box" style="background: #fff;">
                <form class="form-horizontal form-material" id="loginform" action="<?=base_url().'siteman/index'?>" method="post">
                    <h3 class="box-title m-b-20" style="color: #6868">GKI Kranggan form login</h3>
