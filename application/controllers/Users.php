...
class Users extends CI_Controller {
	...
	function index()
	{
		...
		$this->template->load('vta_backend/template','vta_backend/mod_master_users/view',$data);
	}
	...
	function tambah_users()
	{
		if (isset($_POST['submit'])) {
			...
			$data['userss'] = $this->model_app->view_where_order('t_users',array('id_parent'=>0,'position'=>'Side','aktif'=>'Ya'),'id_users','DESC');
			$this->template->load('vta_backend/template','vta_backend/mod_master_users/add',$data);
		}
	...
	function ubah_users()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['userss'] = $this->model_app->view_where_order('t_users',array('id_parent'=>0,'position'=>'Side','aktif'=>'Ya'),'id_users','DESC');
			$this->template->load('vta_backend/template','vta_backend/mod_master_users/edit',$data);
		}
	...
	function profile()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['userss'] = $this->model_app->view_where_order('t_users',array('id_parent'=>0,'position'=>'Side','aktif'=>'Ya'),'id_users','DESC');
			$this->template->load('vta_backend/template','vta_backend/mod_master_users/profile',$data);
		}
